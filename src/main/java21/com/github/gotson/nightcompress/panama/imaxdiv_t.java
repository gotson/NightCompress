...
public class imaxdiv_t {
    ...
    public static long quot$get(MemorySegment seg) {
        return (long)constants$53.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long quot$get(MemorySegment seg, long index) {
        return (long)constants$53.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long rem$get(MemorySegment seg) {
        return (long)constants$53.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long rem$get(MemorySegment seg, long index) {
        return (long)constants$53.const$2.get(seg.asSlice(index*sizeof()));
    }
