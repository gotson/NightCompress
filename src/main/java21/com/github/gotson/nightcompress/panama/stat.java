...
public class stat {
    ...
    public static short st_mode$get(MemorySegment seg) {
        return (short)constants$7.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short st_mode$get(MemorySegment seg, long index) {
        return (short)constants$7.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short st_nlink$get(MemorySegment seg) {
        return (short)constants$7.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short st_nlink$get(MemorySegment seg, long index) {
        return (short)constants$7.const$5.get(seg.asSlice(index*sizeof()));
    }
