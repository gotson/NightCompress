...
public class stat64 {
    ...
    public static short st_mode$get(MemorySegment seg) {
        return (short)constants$10.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short st_mode$get(MemorySegment seg, long index) {
        return (short)constants$10.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short st_nlink$get(MemorySegment seg) {
        return (short)constants$10.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short st_nlink$get(MemorySegment seg, long index) {
        return (short)constants$10.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long st_blocks$get(MemorySegment seg) {
        return (long)constants$11.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long st_blocks$get(MemorySegment seg, long index) {
        return (long)constants$11.const$1.get(seg.asSlice(index*sizeof()));
    }
