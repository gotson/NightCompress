...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        archive_h.C_POINTER.withName("__routine"),
        archive_h.C_POINTER.withName("__arg"),
        archive_h.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = archive_h.upcallHandle(__routine.Function.class, "apply", $DESC);
