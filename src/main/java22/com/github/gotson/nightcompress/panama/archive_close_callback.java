 ...
 * }
 */
public class archive_close_callback {
    ...
    private static final MethodHandle UP$MH = archive_h.upcallHandle(archive_close_callback.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(archive_close_callback.Function fi, Arena arena) {
