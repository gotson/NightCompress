...
public class tm {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        archive_h.C_INT.withName("tm_sec"),
        archive_h.C_INT.withName("tm_min"),
        archive_h.C_INT.withName("tm_hour"),
        archive_h.C_INT.withName("tm_mday"),
        archive_h.C_INT.withName("tm_mon"),
        archive_h.C_INT.withName("tm_year"),
        archive_h.C_INT.withName("tm_wday"),
        archive_h.C_INT.withName("tm_yday"),
        archive_h.C_INT.withName("tm_isdst"),
        MemoryLayout.paddingLayout(4),
        archive_h.C_LONG.withName("tm_gmtoff"),
        archive_h.C_POINTER.withName("tm_zone")
    ).withName("tm");
